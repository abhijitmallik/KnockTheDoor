module.exports = (port,serverConfig)=>{
  ...
  const redisURL = url.parse('redis-12369.c10.us-east-1-3.ec2.cloud.redislabs.com:12369');
  redisConfig.host = 'redis-12369.c10.us-east-1-3.ec2.cloud.redislabs.com';
  redisConfig.port = '12369';
